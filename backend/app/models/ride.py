...
class Ride(db.Model):
    ...
    dynamic_pickup_lat = db.Column(db.Float, nullable=True)
    dynamic_pickup_lng = db.Column(db.Float, nullable=True)
    dynamic_pickup_name = db.Column(db.String(255), nullable=True)
